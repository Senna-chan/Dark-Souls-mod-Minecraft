...
frame20.modelRenderersRotations.put("leaf3", new Quaternion(0.0F, -0.9238795F, 0.0F, 0.38268343F));
frame20.modelRenderersRotations.put("leaf1", new Quaternion(0.0F, 0.38268346F, 0.0F, 0.9238795F));
frame20.modelRenderersRotations.put("leaf2", new Quaternion(0.0F, 0.9238795F, 0.0F, 0.38268343F));
frame20.modelRenderersRotations.put("leaf4", new Quaternion(0.0F, -0.38268346F, 0.0F, 0.9238795F));
frame20.modelRenderersTranslations.put("leaf3", new Vector3f(4.0F, 0.0F, 0.0F));
frame20.modelRenderersTranslations.put("leaf1", new Vector3f(2.0F, 0.0F, 4.0F));
frame20.modelRenderersTranslations.put("leaf2", new Vector3f(5.0F, 0.0F, 3.0F));
frame20.modelRenderersTranslations.put("leaf4", new Vector3f(1.0F, 0.0F, 1.0F));
