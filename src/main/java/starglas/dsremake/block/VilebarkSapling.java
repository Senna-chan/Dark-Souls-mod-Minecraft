...
import starglas.dsremake.world.tree.WorldGenVilebarkTree;

import java.util.Random;

public class VilebarkSapling extends BlockBush implements IGrowable
{
    public static final String[] field_149882_a = new String[] {"Test"};
    private static final IIcon[] field_149881_b = new IIcon[field_149882_a.length];

    protected VilebarkSapling()
    {
        float f = 0.4F;
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        Object object = new WorldGenVilebarkTree(true, 5);
        int i1 = 0;
        int j1 = 0;
        boolean flag = true;
