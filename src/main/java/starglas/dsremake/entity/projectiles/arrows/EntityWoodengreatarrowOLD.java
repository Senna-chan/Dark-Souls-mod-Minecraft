package starglas.dsremake.entity.projectiles.arrows;
...
public class EntityWoodengreatarrowOLD extends Entity implements IProjectile, IEntityAdditionalSpawnData
{
    ...
    public EntityWoodengreatarrowOLD(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityWoodengreatarrowOLD(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityWoodengreatarrowOLD(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityWoodengreatarrowOLD(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void writeEntityToNBT(NBTTagCompound p_70014_1_)
    {
        ...
        p_70014_1_.setInteger("arrow", Item.getIdFromItem(ModItems.WoodenGreatArrow));
    }
    ...
    public void readEntityFromNBT(NBTTagCompound p_70037_1_)
    {
        ...
        this.arrowToPickup = p_70037_1_.getInteger("arrow");
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(Item.getItemById(this.arrowToPickup), 1)))
            {
                flag = false;
            }
