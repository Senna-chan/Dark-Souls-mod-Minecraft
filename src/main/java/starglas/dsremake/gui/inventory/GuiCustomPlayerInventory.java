...

{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		this.fontRendererObj.drawString("Sumething", 80, this.ySize - 96, 4210752);
	}
	/**
	 * 
			...
			int par3)
	{
		...
		mc.getTextureManager().bindTexture(new ResourceLocation("minecraft", "/gui/container/inventory.png"));
