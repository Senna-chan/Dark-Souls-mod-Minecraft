package starglas.dsremake.client.gui;
...
import starglas.dsremake.common.container.ContainerCustomMerchant;
...
public class GuiCustomMerchant extends GuiContainer
{
    ...
    private static final ResourceLocation texture = new ResourceLocation("textures/gui/container/villager.png");
    private IMerchant merchant;
    private GuiCustomMerchant.MerchantButton field_147043_x;
    private GuiCustomMerchant.MerchantButton field_147042_y;
    private int field_147041_z;
    private String field_147040_A;
    private static final String __OBFID = "CL_00000762";

    public GuiCustomMerchant(InventoryPlayer playerInv, IMerchant merchant, World world, String villagerName)
    {
        super(new ContainerCustomMerchant(playerInv, merchant, world));
        this.merchant = merchant;
        this.field_147040_A = villagerName != null && villagerName.length() >= 1 ? villagerName : I18n.format("entity.Villager.name", new Object[0]);
    }
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_147043_x = new GuiCustomMerchant.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
        this.buttonList.add(this.field_147042_y = new GuiCustomMerchant.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
    ...
    static class MerchantButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
            {
                if (this.visible)
                {
                    p_146112_1_.getTextureManager().bindTexture(GuiCustomMerchant.texture);
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
