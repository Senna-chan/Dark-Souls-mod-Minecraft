...
public class AnimationHandlerEldermushan extends AnimationHandler {
	/** Map with all the animations. */
	public static HashMap<String, Channel> animChannels = new HashMap<String, Channel>();
static
{
animChannels.put("walk", new ChannelWalk("walk", 30.0F, 40, Channel.LOOP));
}
	public AnimationHandlerEldermushan(IMCAnimatedEntity entity) {
		super(entity);
	}
